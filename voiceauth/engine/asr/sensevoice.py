...
from voiceauth.domain.protocols.asr import ASRResult, TokenInfo
from voiceauth.engine.exceptions import ASRError, ModelNotLoadedError
...
class SenseVoiceASR:
    ...
    Implements ASRProtocol from voiceauth.domain.protocols.asr.
    """
