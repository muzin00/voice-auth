...
from voiceauth.engine.exceptions import ModelNotLoadedError, SpeakerEmbeddingError
from voiceauth.engine.settings import settings


class CAMPPVoiceprint:
    """Voiceprint extractor using CAM++.

    Implements VoiceprintProtocol from voiceauth.domain.protocols.voiceprint.
    """
